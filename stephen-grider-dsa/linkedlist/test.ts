import { Node, LinkedList as List } from './index';
...
describe('A Node', () => {
  test('has properties "data" and "next"', () => {
    const previousNode = new Node<number>(9);

    const node = new Node<number>(10, previousNode);
...
describe('Size', () => {
  test('returns the number of items in the linked list', () => {
    ...
    l.insertFirst(1).insertFirst(1).insertFirst(1).insertFirst(1);
...
describe('RemoveFirst', () => {
  ...
  test('removes the first node when the list has a size of three', () => {
    const l = new List<string>();
    l.insertFirst('c').insertFirst('b').insertFirst('a').removeFirst();
...
describe('RemoveLast', () => {
  ...
  test('RemoveLast removes the last node when list is length 3', () => {
    const l = new List<string>();
    l.insertFirst('c').insertFirst('b').insertFirst('a').removeLast();

    expect(l.size()).toEqual(2);
    expect(l.getLast()?.data).toEqual('b');
  });

  test('RemoveLast removes the last node when list is length 6', () => {
    const l = new List<string>();
    l.insertFirst('f')
      .insertFirst('e')
      .insertFirst('d')
    ...
    expect(l.getLast()?.data).toEqual('e');
  });
});
